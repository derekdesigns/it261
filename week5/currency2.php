...
<head>
<meta charset="UTF-8">
<title>Our Currency 2 Form with dropdown select option</title>
...
<ul>
<li><input type="radio" name="currency" value=".013">Rubles</li>
<li><input type="radio" name="currency" value=".76">Canadian</li>
<li><input type="radio" name="currency" value="1.28">Pounds</li>
<li><input type="radio" name="currency" value="1.18">Euross</li>
<li><input type="radio" name="currency" value=".0094">Yen</li>
</ul>
