...
<label for="hours_per_day">How many hours per day do you plan on driving?</label>
<input type="text" name="hours_per_day" value="
<?php if(isset($_POST['hours_per_day'])) echo htmlspecialchars($_POST['hours_per_day']) ; ;?>
">

<label for="gas_price">Gas Price per Gallon</label>
<ul>
...
$total_days      = ($miles / $speed) / $hours_per_day;
...
<div class="box">
<h2>Hello '.$name.'!</h2>
<p>You will be driving '.$miles.' miles. With a fuel efficiency rating of '.$fuel_efficiency.', your fuel cost will be $'.$total_cost.' and your trip will take '.$total_days.' days.</p>
</div>
';
